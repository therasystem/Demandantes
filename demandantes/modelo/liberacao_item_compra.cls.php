...
class clsLiberacaoItemCompra {
    ...
    public function ListaItemCompraPesq($idcompra = "", $pesq = "") {
        ...
        $html = '<table border = "0" cellspacing = "3" cellpadding = "0">
                ...
                <td title = "Adicionar Item de Compra" width = "30px" align = "right"><a href = "liberacao_item_compra_alteracao.frm.php"><img name = "btnsalvar" id = "btnsalvar" src = "../imagens/novo.gif" width = "22" ></a></td>
                </tr>
...
/// olharrrrrrrrrrr
        ...
        if ($tbl->RecordCount() > 0) {
            foreach ($tbl as $chave => $linha) {
                ...
                <td align = "center"><a href = "liberacao_item_compra_alteracao.frm.php?iditemcompra=' . htmlentities($linha['IDITEM']) . '&metodo=1"><img border = "0" src = "../imagens/bt_editar.jpg" width = "24px" ></a> </td>
                <td align = "center"><a href = "liberacao_item_compra.exe.php?iditemcompra=' . htmlentities($linha['IDITEM']) . '&metodo=2"><img border = "0" src = "../imagens/cancelar.png" width = "20px" ></a> </td>
                </tr>';
            }

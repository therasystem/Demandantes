...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <table align="center" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td valign="top">
                    <form id="form1" name="form1" method="post" action="liberacao_compra.frm.php">
                                    ...
                                    <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td valign="top">
                                                ...
                                                <a href="#" onclick="PrintElementID('printableArea');"><img name="btnsalvar" id="btnsalvar" src = "../imagens/print.png" width = "22" /></a>
                                                
                                                
                                                <div id="printableArea" class="imprimir">
                                                <?php echo $compra->CotacaoPreco($idcompra) ?>
                                                </div>
                                            </td>
                                        </tr>
                                    </table> 

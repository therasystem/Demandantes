    ...
    <body >
        ...
        <div class="container" style="background: white; padding-left: 2em; border-radius: 10px 10px;-webkit-border-radius: 10px 10px;-moz-border-radius: 10px;">
            ...
            <div class="masthead"  >
                ...
                <div class="container">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="#">Região Domiciliar</a></li>
            ...
            <form id="form1" name="form1" method="post" class="form-inline" action="domiciliar.exe.php"> 
                ...
                <div class="row-fluid">
                    <div class="span4">
                        <h3>Dados Região Domiciliar</h3 >
                        <div class="control-group">

                            <div class="control-group">
                                <div style="margin-top: 1%"></div>
                                <label class="control-label">Existe calçamento/pavimentação no trecho do logradouro em frente ao seu domicílio?</label>
                                <div  class="controls">
                                ...
                                <div style="margin-top: 1%"></div>
                                <label class="control-label">Existe sistema público de captação e tratamento de esgoto?</label>
                                <div  class="controls">
                                    <span id="pnee_titular">
                                        <input type="radio"  class="radio">
                                        SIM
                                ...
                                <div style="margin-top: 1%"></div>
                                <label class="control-label">Existe escola primária ou posto de saúde a uma distância máxima de três quilometros do domicílio?</label>
                                <div  class="controls">
                                    <span id="pnee_titular">
                                        <input type="radio"  class="radio">
                                        SIM
                    ...
                    <div class="row-fluid" style="margin-top: 5.5%;">
                        <div class="span4">
                            ...
                            <div style="margin-top: 1%"></div>
                            <label class="control-label">Existe sistema de transporte público?</label>
                            <div  class="controls">
                                <span id="pnee_titular">
                                    <input type="radio"  class="radio">
                                    SIM
                            ...
                            <div style="margin-top: 1%"></div>
                            <label class="control-label">Existe rede de iluminacao publica com distribuição domiciliar?</label>
                            <div  class="controls">
                                <span id="pnee_titular">
                                    <input type="radio"  class="radio">
                                    SIM
                            ...
                            <div style="margin-top: 1%"></div>
                            <label class="control-label">O domicílio está em área de risco ou insalubre?</label>
                            <div  class="controls">
                                <span id="pnee_titular">
                                    <input type="radio"  class="radio">
                                    SIM
                        ...
                        <div class="row-fluid" style="margin-top: 0%;margin-left: 2%">
                            <div style="margin-top: 0%;margin-left: 2%" class="span4">
                                ...
                                <div style="margin-top: 1%"></div>
                                <label class="control-label">Existe sistema público de captação, tratamento e abastecimento de água?</label>
                                <div  class="controls">
                                    <span id="pnee_titular">
                                        <input type="radio"  class="radio">
                                        SIM
                                ...
                                <div style="margin-top: 1%"></div>
                                <label class="control-label">Existe sistema viário com meio-fio ou calçamento, com canalização de águas plúviais?			
                                </label>
                                <div  class="controls">
                                    <span id="pnee_titular">
                                        <input type="radio"  class="radio">

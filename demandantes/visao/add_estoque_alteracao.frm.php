...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <table align="center" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td valign="top"> 
                    <form id="form1" name="form1" method="post" action="add_estoque.exe.php"> 
                        <input type="hidden" name="metodo" id="metodo" value="<?php echo $metodo ?>"/>
                        <input type="hidden" name="codigo" id="codigo" value="<?php echo $addEstoque->getCodigo() ?>"/>
                                ...
                                <td width="100%" bgcolor="#EEFFDD">
                                    <table cellpadding="0" cellspacing="0" class="style4">
                                        <tr>
                                            ...
                                            <td>&nbsp;<a href="add_estoque.frm.php"><b>VOLTAR</b></a></td>
                                            <td>&nbsp;&nbsp;&nbsp;</td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td  height="36"><b><br />&nbsp;&nbsp;&nbsp;ADICIONAR AO ESTOQUE<br /> 
                                                    </tr>
                                                    <tr> 
                                                        <tr>
                                                            <td height="30px" align="right" class="small">Obra: </td>
                                                            <td>
                                                                <select name="IDOBRA">
                                                                    <?php echo $obra->ListaComboObraALLPesc($addEstoque->getIdobra()); ?>
                                                                </select>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select name="IDMATERIAL">
                                                                    <?php echo $material->ListaComboMaterialALL($addEstoque->getIdmaterial()); ?>
                                                                </select>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select name="IDUNIDADE">
                                                                    <?php echo $unidade->ListaComboUnidadeALL($addEstoque->getIdunidade()); ?>
                                                                </select>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td  align="right" class="small">Quantidade:</td>
                                                            <td><input class="campo_texto" name="QUANTIDADE" type="text" value='<?php echo $addEstoque->getQuantidade() ?>' size="40" maxlength="10"></td>
                                                        </tr>
                                                        <tr>
                                                            <td  align="right" class="small">Data Entrada:</td>
                                                            <td>
                                                                <input class="campo_texto" name="DATAENTRADA" type="text" value='<?php echo $addEstoque->getDataentrada() ?>' size="15" maxlength="10" onkeyup="mascaraData(this, event);">

...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <table align="center" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td valign="top"> 
                    <form id="form1" name="form1" method="post" action="processo_inicio.exe.php"> 
                        <input type="hidden" name="metodo" id="metodo" value="<?php echo $metodo ?>"/>
                        <input type="hidden" name="codigo" id="codigo" value="<?php echo $procInicio->getCodigo() ?>"/>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td  height="36"><b><br />&nbsp;&nbsp;&nbsp;INICIO PROCESSO<br /> 
                                                    </tr>
                                                    <tr>
                                                        <tr>
                                                            <td align="right" class="small">Processo Origem: </td>
                                                            <td>
                                                                <select name="IDORI">
                                                                    <?php echo $procOri->ListaComboOriProcALL($procInicio->getIdoriproc()); ?>
                                                                </select>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right" class="small">Descri&ccedil;&atilde;o: </td>
                                                            <td><input  class="campo_texto" name="DESC" id="DESC" type="text" value='<?php echo $procInicio->getDescricao() ?>' size="40"  maxlength="100">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td></td>

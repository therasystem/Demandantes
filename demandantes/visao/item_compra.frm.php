...
if ((isset($_SESSION['codigo']))) {
    ...
    $livre = $itemCompra->Liberado($_GET['idcompra']);
    if ($livre == false) {
        $msg = "Não é possível inserir mais itens de compra caso exista alguma autorização liberada!";
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <table align="center" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td valign="top">
                    <form id="form1" name="form1" method="post" action="item_compra.frm.php?idcompra=<?php echo $_SESSION['idcompra'] ?>">
                                ...
                                <td width="100%" bgcolor="#EEFFDD">
                                    <table cellpadding="0" cellspacing="0" class="style4">
                                        <tr>
                                            ...
                                            <td>&nbsp;<a href="compra.frm.php"><b>VOLTAR</b></a></td>
                                            <td>&nbsp;&nbsp;&nbsp;</td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td  height="36"><b><br />&nbsp;&nbsp;&nbsp;CADASTRO DE ITEM DE COMPRA<br /> 
                                                    </tr>
                                                    <tr>
                                                        <td valign="top">

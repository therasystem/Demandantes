...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <table align="center" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td valign="top"> 
                    <form id="form1" name="form1" method="post" action="cargo.exe.php"> 
                        <input type="hidden" name="metodo" id="metodo" value="<?php echo $metodo ?>"/>
                        <input type="hidden" name="codigo" id="codigo" value="<?php echo $cargo->getCodigo() ?>"/>
                                ...
                                <td width="100%" bgcolor="#EEFFDD">
                                    <table cellpadding="0" cellspacing="0" class="style4">
                                        <tr>
                                            ...
                                            <td>&nbsp;<a href="cargo.frm.php"><b>VOLTAR</b></a></td>
                                            <td>&nbsp;&nbsp;&nbsp;</td>
                                            ...
                                            <td  height="36"><b><br />&nbsp;&nbsp;&nbsp;CADASTRO DE CARGO<br /> 
                                                    ...
                                                    <tr> 
                                                        <tr>
                                                            ...
                                                            <td><input class="campo_texto" name="CARGO" type="text" value='<?php echo $cargo->getNome() ?>' size="40" maxlength="100"></td>
                                                        </tr>
                                                        <tr>
                                                            <td></td>
                                                            <td>

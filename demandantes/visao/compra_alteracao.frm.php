...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <table align="center" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td valign="top"> 
                    <form id="form1" name="form1" method="post" action="compra.exe.php"> 
                        <input type="hidden" name="metodo" id="metodo" value="<?php echo $metodo ?>"/>
                        <input type="hidden" name="codigo" id="codigo" value="<?php echo $compra->getCodigo() ?>"/>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td  height="36"><b><br />&nbsp;&nbsp;&nbsp;CADASTRO DE COMPRA<br /> 
                                                    </tr>
                                                    <tr> 
                                                        <tr>
                                                            <td align="center" class="small">Obra: 
                                                                <select name="OBRA">
                                                                    <?php echo $obra->ListaComboObraALL(); ?>
                                                                </select></td> 
                                                        </tr>
                                                        <tr> 
                                                            <td align="center">

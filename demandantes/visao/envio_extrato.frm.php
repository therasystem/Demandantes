...
require_once("../modelo/envioExtrato.cls.php");

$config = new clsConfig();

if ((isset($_SESSION['codigo']))) {
    $relat = new clsEnvioExtrato();
    $centro = new clsCentroCustoFinanceiro();
    $admin = new clsUsuario();
    $admin->SelecionaPorCodigo(trim($_SESSION['codigo']));

    if ((isset($_POST['ano'])) && ($_FILES["arquivo"]["error"] <= 0)) {

        $relat->SalvarExtrato($_FILES['arquivo'], $_POST['mes'], $_POST['ano'], $_POST['IDCENTROFINANC']);
        $config->ConfirmaOperacao($config->GetPaginaMenu(), "Arquivo enviado com sucesso");
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="font-family: arial">
        ...
        <table align="center" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td valign="top"> 
                    <form id="form1" name="form1"  method="post" action="envio_extrato.frm.php" enctype="multipart/form-data">  
                                                    ...
                                                    <tr>  
                                                        <tr>
                                                            <td align="center" class="small"><br/>
                                                                Envie o extrato bancário: <span style="color: red">*</span>
                                                        ...
                                                        <tr>
                                                            <td align="center" class="small"><br/>
                                                                Mês do Extrato: <span style="color: red">*</span>
                                                        ...
                                                        <tr>
                                                            <td align="center" class="small"><br/>
                                                                Ano do Extrato: <span style="color: red">*</span>

...
if ((isset($_SESSION['codigo']))) {
    ...
    $voltar = "centro_custo.frm.php?metodo=2&idcentro=".$idcentro;
            ...
            <tr>
                <td valign="top"> 
                    <form id="form1" name="form1" method="post" action="centro_custo.exe.php"> 
                        ...
                        <input type="hidden" name="voltar" id="voltar" value="<?php echo $voltar ?>"/>
                                            ...
                                            <td  height="36"><b><br />&nbsp;&nbsp;&nbsp;CENTRO DE CUSTO<br /> 
                                                    ...
                                                    <tr> 
                                                        <tr>
                                                            ...
                                                            <td><input class="campo_texto" name="DESCCENTRO" type="text" value='' size="40" maxlength="100"></td>
                                                        </tr>
                                                        <tr>
                                                            <td></td>
                                                            <td>

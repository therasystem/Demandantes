...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <table align="center" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td valign="top">
                    <form id="form1" name="form1" method="post" action="processo_inicio.frm.php">
                                ...
                                <td width="100%" bgcolor="#EEFFDD">
                                    <table cellpadding="0" cellspacing="0" class="style4">
                                        <tr>
                                            ...
                                            <td>&nbsp;<a href="admin_processo.frm.php"><b>VOLTAR</b></a></td>
                                            <td>&nbsp;&nbsp;&nbsp;</td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td  height="36"><b><br />&nbsp;&nbsp;&nbsp;Início de Processo<br /> 
                                                    </tr>
                                                    <tr>
                                                        <td valign="top">
                                                            <?php echo $procInicio->ListaProcIniPesq($pesq) ?>
                                                        </td>
                                                    </tr>
                                                    </table> 
                                            </td>

...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <table align="center" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td valign="top"> 
                    <form id="form1" name="form1" method="post" action="material.exe.php"> 
                                ...
                                <td width="100%" bgcolor="#EEFFDD">
                                    <table cellpadding="0" cellspacing="0" class="style4">
                                        <tr>
                                            ...
                                            <td>&nbsp;<a href="material.frm.php"><b>VOLTAR</b></a></td>
                                            <td>&nbsp;&nbsp;&nbsp;</td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td  height="36"><b><br />&nbsp;&nbsp;&nbsp;CADASTRO DE MATERIAL<br /> 
                                                    </tr>
                                                    <tr> 
                                                        <tr>
                                                            <td  align="right" class="small">Material:</td>
                                                            <td><input class="campo_texto" name="NOME" type="text" value='<?php echo $material->getDescricao() ?>' size="40" maxlength="150"></td>
                                                        </tr>
                                                        <tr>
                                                            <td  align="right" class="small">Sigla:</td>
                                                            <td><input class="campo_texto" name="TIPO" type="text" value='<?php echo $material->getTipo() ?>' size="20" maxlength="15"></td>
                                                        </tr>
                                                        <tr>
                                                            <td></td>
                                                            <td>

...
<html>
    ...
    <body >
        ...
        <div class="container" style="background: white; padding-left: 2em; border-radius: 10px 10px;-webkit-border-radius: 10px 10px;-moz-border-radius: 10px;">
            ...
            <div class="masthead"  >
                ...
                <div class="container">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="#">Dados do imóvel</a></li>
                    </ul>
                </div>
            ...
            <form id="form1" name="form1" method="post" class="form-inline" action="dadosimovel.exe.php"> 
                <input type="hidden" name="metodo" id="metodo" value="<?php echo $metodo ?>"/>
                <input type="hidden" name="codigo" id="codigo" value="<?php echo $imovel->getCodigo() ?>"/>
                <div class="row-fluid">
                    <div class="span4">
                        <h3>Dados Imóvel</h3 >
                        <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <label class="control-label">Quantas pessoas vão morar no imóvel?</label>
                                <div  class="controls">
                                    <input style="height: 30px;" name="QUANTMORADORES" type="text" value="<?php echo $imovel->getQUANTMORADORES() ?>"  />
                                </div>
                                ...
                                <div  class="controls">
                                    <select style="width: 200px;" name="IDMUNICIPIO">
                                        ...
                                        echo $gerador->ListaComboALL($imovel->getIDMUNICIPIO());
                                        ?>
                                    </select>
                                </div>
                                ...
                                <div style="margin-top: 1%"></div>
                                <label class="control-label">Bairro 02:</label>
                                <div  class="controls">
                                    <input style="height: 30px;" name="BAIRRO2" type="text" value="<?php echo $imovel->getBAIRRO2() ?>"  />
                                </div>
                    ...
                    <div class="row-fluid" style="margin-top: 5.5%;">
                        <div class="span4">
                            ...
                            <div style="margin-top: 1%"></div>
                            <label class="control-label">Qual a pretenção em relação ao imóvel?</label> 
                            <div style="margin-top: 1%"></div>
                            <label class="control-label">Região metropolitana:</label>
                            <div  class="controls">
                            ...
                            <div style="margin-top: 1%"></div>
                            <label class="control-label">Bairro 03:</label>
                            <div  class="controls">
                                <input style="height: 30px;" name="BAIRRO3" type="text" value="<?php echo $imovel->getBAIRRO3() ?>"  />
                            </div>
                        ...
                        <div class="row-fluid" style="margin-top: 0%;">
                            <div class="span4">
                                ...
                                <div  class="controls">
                                    <select style="width: 200px;" name="IDESTADO">
                                        <?php
                                        $gerador = new clsGeradorGenerico("estado");
                                        echo $gerador->ListaComboALL3colunas($imovel->getIDESTADO());
                                        ?>
                                    </select>
                                </div>
                                <div style="margin-top: 1%"></div>
                                <label class="control-label">Bairro 01:</label>
                                <div  class="controls">
                                    <input style="height: 30px;" name="BAIRRO1" type="text" value="<?php echo $imovel->getBAIRRO1() ?>"  />
                                </div>

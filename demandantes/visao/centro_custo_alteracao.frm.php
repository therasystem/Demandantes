...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <table align="center" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td valign="top"> 
                    <form id="form1" name="form1" method="post" action="centro_custo.exe.php"> 
                        <input type="hidden" name="metodo" id="metodo" value="<?php echo $metodo ?>"/>
                        <input type="hidden" name="codigo" id="codigo" value="<?php echo $centroCusto->getCodigo() ?>"/>
                                ...
                                <td width="100%" bgcolor="#EEFFDD">
                                    <table cellpadding="0" cellspacing="0" class="style4">
                                        <tr>
                                            ...
                                            <td>&nbsp;<a href="centro_custo.frm.php"><b>VOLTAR</b></a></td>
                                            <td>&nbsp;&nbsp;&nbsp;</td>
                                            ...
                                            <td  height="36"><b><br />&nbsp;&nbsp;&nbsp;CENTRO DE CUSTO<br /> 
                                                    ...
                                                    <tr> 
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select name="IDOBRA">
                                                                    <?php echo $obra->ListaComboObraALLPesc($centroCusto->getIdobra()); ?>
                                                                </select>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td  align="right" class="small">Descrição:</td>
                                                            <td><input class="campo_texto" name="DESCCENTRO" type="text" value='<?php echo $centroCusto->getDescCentro() ?>' size="40" maxlength="100"></td>
                                                        </tr>
                                                        <tr>
                                                            <td></td>
                                                            <td>
